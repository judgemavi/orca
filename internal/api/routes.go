...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("POST /api/v1/tasks/{id}/decompose", s.handleDecomposeTask)
	mux.HandleFunc("POST /api/v1/tasks/{id}/decompose/accept", s.handleAcceptDecompose)
	mux.HandleFunc("POST /api/v1/tasks/{id}/decompose/reject", s.handleRejectDecompose)
