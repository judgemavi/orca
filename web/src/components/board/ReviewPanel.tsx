...
export function ReviewPanel({
  ...
  return (
    <div className="flex w-120 shrink-0 flex-col overflow-hidden border-l border-border-subtle">
      ...
      <div className="flex flex-1 flex-col gap-3 overflow-y-auto px-4 py-3">
        ...
        {reviewTasks.map((task) => (
          <button
            key={task.id}
            className="flex flex-col gap-1 rounded-lg border border-border-subtle bg-surface-alt px-3 py-2 text-left hover:bg-surface"
