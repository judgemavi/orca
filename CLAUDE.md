...
- `DESIGN.md` — Core design doc (v0.3). Architecture, scrum model, roles (tech lead/dev/reviewer/integrator), phases (explore/plan/sprint/review/integrate), worktree isolation, supervisor modes (manual/autopilot), worker execution model, CLI interface, TUI design, config format. This is the source of truth for what Orca is.
